...
Shader "TFE/Toon/Lightning PBR Dissolve Local"
{
	Properties
	{
		...
		[Enum(X,0,Y,1,Z,2)]_HeightVertexAxis("Height Vertex Axis", Int) = 1
		[Toggle]_CheckRemapHeight("Check RemapHeight", Float) = 0
		...
		_HeightGradientAndDissolveRemap("HeightGradientAndDissolveRemap", Vector) = (0,1,0,1)
	...
	SubShader
	{
		...
		uniform float _CheckRemapHeight;
		...
		uniform float4 _HeightGradientAndDissolveRemap;
		uniform int _HeightVertexAxis;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			#endif
			float temp_output_3_0_g29 = _BorderMask;
			float temp_output_27_0_g29 = (-temp_output_3_0_g29 + (_StepValue - 0.0) * (( 1.005 + temp_output_3_0_g29 ) - -temp_output_3_0_g29) / (1.0 - 0.0));
			int temp_output_4_0_g20 = _DissolveChannel;
			float2 uv0_DissolveTexture = i.uv_texcoord * _DissolveTexture_ST.xy + _DissolveTexture_ST.zw;
			float4 tex2DNode283 = tex2D( _DissolveTexture, uv0_DissolveTexture );
			float temp_output_7_0_g20 = (( (float)temp_output_4_0_g20 == 0.0 ) ? tex2DNode283.r :  tex2DNode283.g );
			float temp_output_12_0_g20 = (( (float)temp_output_4_0_g20 == 2.0 ) ? tex2DNode283.b :  temp_output_7_0_g20 );
			float temp_output_3_0_g23 = (( (float)temp_output_4_0_g20 == 3.0 ) ? tex2DNode283.a :  temp_output_12_0_g20 );
			float temp_output_275_0 = (_HeightGradientAndDissolveRemap.z + (_Value - 0.0) * (_HeightGradientAndDissolveRemap.w - _HeightGradientAndDissolveRemap.z) / (1.0 - 0.0));
			float temp_output_4_0_g23 = 0.25;
			...
			int temp_output_4_0_g31 = _HeightVertexAxis;
			float3 ase_vertex3Pos = mul( unity_WorldToObject, float4( i.worldPos , 1 ) );
			float temp_output_7_0_g31 = (( (float)temp_output_4_0_g31 == 0.0 ) ? ase_vertex3Pos.x :  ase_vertex3Pos.y );
			float temp_output_12_0_g31 = (( (float)temp_output_4_0_g31 == 2.0 ) ? ase_vertex3Pos.z :  temp_output_7_0_g31 );
			float temp_output_241_0 = (0.0 + (temp_output_12_0_g31 - _HeightGradientAndDissolveRemap.x) * (1.0 - 0.0) / (_HeightGradientAndDissolveRemap.y - _HeightGradientAndDissolveRemap.x));
			float temp_output_247_0 = saturate( temp_output_241_0 );
			float temp_output_3_0_g26 = temp_output_247_0;
			float temp_output_4_0_g26 = 0.25;
			float temp_output_6_0_g26 = (-temp_output_4_0_g26 + (temp_output_275_0 - 0.0) * (( temp_output_4_0_g26 + 1.0 ) - -temp_output_4_0_g26) / (1.0 - 0.0));
			float temp_output_9_0_g26 = ( temp_output_6_0_g26 - temp_output_4_0_g26 );
			float temp_output_2_0_g28 = temp_output_9_0_g26;
			float temp_output_11_0_g26 = ( temp_output_6_0_g26 + temp_output_4_0_g26 );
			float temp_output_1_0_g29 = ( saturate( ( ( temp_output_3_0_g23 - temp_output_2_0_g25 ) / ( temp_output_11_0_g23 - temp_output_2_0_g25 ) ) ) * saturate( ( ( temp_output_3_0_g26 - temp_output_2_0_g28 ) / ( temp_output_11_0_g26 - temp_output_2_0_g28 ) ) ) );
			float temp_output_8_0_g29 = step( ( temp_output_27_0_g29 - temp_output_3_0_g29 ) , temp_output_1_0_g29 );
			float DissolveMask221 = saturate( temp_output_8_0_g29 );
			float temp_output_4_0_g30 = _OutputSelection;
			float Debug167 = 0.0;
			float4 temp_cast_12 = (Debug167).xxxx;
			...
			float3 triplanar17_g17 = TriplanarSamplingSNF( _NormalTex, ase_worldPos, ase_worldNormal, TriplanarFallOffg74, temp_output_13_0_g17, temp_output_11_0_g17, 0 );
			...
			float4 temp_output_7_0_g18 = (( temp_output_4_0_g18 == 0.0 ) ? float4( temp_output_94_0 , 0.0 ) :  float4( temp_output_94_0 , 0.0 ) );
			float4 temp_output_12_0_g18 = (( temp_output_4_0_g18 == 2.0 ) ? float4( newWorldNormal4_g17 , 0.0 ) :  temp_output_7_0_g18 );
			float3 ase_normWorldNormal = normalize( ase_worldNormal );
			float4 WorldNormal27 = (( _UseMeshNormal )?( float4( ase_normWorldNormal , 0.0 ) ):( temp_output_12_0_g18 ));
			...
			float temp_output_4_0_g19 = DisplayType69;
			float4 triplanar46 = TriplanarSamplingSF( _BaseColor, ase_worldPos, ase_worldNormal, TriplanarFallOffg74, Tiling73, 1.0, 0 );
			float4 temp_output_7_0_g19 = (( temp_output_4_0_g19 == 0.0 ) ? _MainColor :  tex2D( _BaseColor, UV61 ) );
			float4 temp_output_12_0_g19 = (( temp_output_4_0_g19 == 2.0 ) ? triplanar46 :  temp_output_7_0_g19 );
			float4 temp_output_67_0 = temp_output_12_0_g19;
			...
			#endif
			float3 temp_cast_21 = (_MinGradient).xxx;
			float3 temp_cast_22 = (( max( _MinGradient , _MaxGradient ) + 0.001 )).xxx;
			float3 temp_output_113_0 = (temp_cast_21 + (staticSwitch55 - float3( 0,0,0 )) * (temp_cast_22 - temp_cast_21) / (float3( 1,1,1 ) - float3( 0,0,0 )));
			...
			float3 temp_cast_23 = (_MinGradient).xxx;
			float3 temp_cast_24 = (( max( _MinGradient , _MaxGradient ) + 0.001 )).xxx;
			float3 BaseColor83 = ( (temp_output_67_0).xyz * (_Tint).rgb );
			...
			float3 temp_cast_26 = (_MaxGlossiness).xxx;
			float3 clampResult212 = clamp( Specular150 , float3( 0,0,0 ) , temp_cast_26 );
			#if defined(LIGHTMAP_ON) && ( UNITY_VERSION < 560 || ( defined(LIGHTMAP_SHADOW_MIXING) && !defined(SHADOWS_SHADOWMASK) && defined(SHADOWS_SCREEN) ) )//aselc
			float4 ase_lightColor = 0;
			#else //aselc
			float4 ase_lightColor = _LightColor0;
			#endif //aselc
			float4 temp_output_160_0 = ( UNITY_LIGHTMODEL_AMBIENT * float4( BaseColor83 , 0.0 ) * _AmbientLightInfluence );
			float4 temp_output_7_0_g30 = (( temp_output_4_0_g30 == 0.0 ) ? ( float4( ( ( saturate( Diffuse21 ) + clampResult212 ) * ( ase_lightColor.rgb * ase_lightAtten ) ) , 0.0 ) + temp_output_160_0 ) :  float4( Diffuse21 , 0.0 ) );
			float4 temp_output_12_0_g30 = (( temp_output_4_0_g30 == 2.0 ) ? float4( Specular150 , 0.0 ) :  temp_output_7_0_g30 );
			float4 Output162 = (( temp_output_4_0_g30 == 3.0 ) ? temp_cast_12 :  temp_output_12_0_g30 );
			c.rgb = Output162.xyz;
			c.a = 1;
		...
		void surf( Input i , inout SurfaceOutputCustomLightingCustom o )
		{
			...
			float temp_output_1_0_g29 = ( saturate( ( ( temp_output_3_0_g23 - temp_output_2_0_g25 ) / ( temp_output_11_0_g23 - temp_output_2_0_g25 ) ) ) * saturate( ( ( temp_output_3_0_g26 - temp_output_2_0_g28 ) / ( temp_output_11_0_g26 - temp_output_2_0_g28 ) ) ) );
			float temp_output_8_0_g29 = step( ( temp_output_27_0_g29 - temp_output_3_0_g29 ) , temp_output_1_0_g29 );
			float temp_output_5_0_g29 = step( temp_output_27_0_g29 , temp_output_1_0_g29 );
			float4 BorderMask227 = ( _DissolveBorderColor * saturate( ( temp_output_8_0_g29 - temp_output_5_0_g29 ) ) );
			float RemapHeight288 = (( temp_output_247_0 >= 1E-05 && temp_output_247_0 <= 0.99999 ) ? temp_output_247_0 :  0.5 );
			float4 temp_cast_5 = (RemapHeight288).xxxx;
			o.Emission = (( _CheckRemapHeight )?( temp_cast_5 ):( BorderMask227 )).rgb;
		}
...
/*ASEBEGIN
Version=17402
296;73;827;595;4220.853;-692.4238;4.047379;True;False
Node;AmplifyShaderEditor.CommentaryNode;81;-5258.795,2701.032;Inherit;False;2492.105;862.9327;Comment;22;295;83;164;165;67;46;19;17;61;16;63;62;69;66;74;73;48;49;47;296;297;298;Base Color;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;45;-6166.845,-863.3413;Inherit;False;Property;_NormalScale;NormalScale;15;0;Create;True;0;0;False;1;Space(20);1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;14;-6280.826,-1044.389;Inherit;True;Property;_NormalTex;NormalTex;14;1;[Normal];Create;True;0;0;False;0;ea423bfa3028414449f0585c59cb25c5;02b3a375f0af6144aa48be89e4980601;True;bump;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.FunctionNode;93;-5847.821,-890.9803;Inherit;False;Blend World and NormalTex;-1;;17;a41941b1668fdfa4886041bd0a82573b;1,16,1;4;13;FLOAT2;1,1;False;10;SAMPLER2D;0;False;11;FLOAT;1;False;19;FLOAT;0.5;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.FunctionNode;68;-5405.226,-955.9498;Inherit;False;Switch Vector;-1;;18;aee5c6d08ca784945b154b9b7d527020;1,9,1;5;4;FLOAT;0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;59;-5080.671,-880.4727;Inherit;False;Property;_UseMeshNormal;Use Mesh Normal;13;0;Create;True;0;0;False;1;Header(Normal);0;2;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.TexturePropertyNode;16;-4298.999,2949.674;Inherit;True;Property;_BaseColor;BaseColor;10;0;Create;True;0;0;False;0;da342a520889920408bdfa1aab8f912d;3796932372e744943b4716fc0dfb293c;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.ColorNode;17;-3946.63,2784.162;Inherit;False;Property;_MainColor;Main Color;11;0;Create;False;0;0;False;0;1,0.3537736,0.3537736,0;0.95283,0.8001212,0.2561854,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;67;-3527.079,2986.032;Inherit;False;Switch Vector;-1;;19;aee5c6d08ca784945b154b9b7d527020;1,9,1;5;4;FLOAT;0;False;2;FLOAT4;0,0,0,0;False;3;FLOAT4;0,0,0,0;False;5;FLOAT4;0,0,0,0;False;6;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;165;-3173.004,3208.717;Inherit;False;False;False;False;True;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;213;-5975.213,-2201.592;Inherit;True;Property;_GlossMap;GlossMap;19;0;Create;True;0;0;False;0;None;None;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;164;-2984.559,3211.182;Inherit;False;AlbedoAlpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;163;-5310.082,-2126.343;Inherit;False;Property;_GlossInAlbedoAlpha;GlossInAlbedoAlpha;23;0;Create;True;0;0;False;0;1;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;215;-5372.189,-1424.13;Inherit;True;Property;_MetalMap;MetalMap;28;0;Create;True;0;0;False;0;None;209b9f5e35c243c4bbd7666ab799b120;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.RangedFloatNode;142;-5038.97,-1220.712;Inherit;False;Property;_Metalness;Metalness;24;0;Create;True;0;0;False;1;Header(Metalness);0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;99;-5306.298,-1967.04;Inherit;False;Property;_Smoothness;Smoothness;16;0;Create;True;0;0;False;1;Header(Glossiness);0.5;0.425;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;295;-3574.827,3249.555;Inherit;False;Property;_Tint;_Tint;12;0;Create;True;0;0;False;0;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ComponentMaskNode;296;-3390.255,3213.597;Inherit;False;True;True;True;False;1;0;COLOR;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ComponentMaskNode;298;-3296.767,3098.535;Inherit;False;True;True;True;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;297;-3133.162,3082.354;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;83;-3116.886,2984.747;Inherit;False;BaseColor;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;84;-3961.499,468.6038;Inherit;False;83;BaseColor;1;0;OBJECT;;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-3529.993,494.9496;Inherit;False;3;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.CommentaryNode;248;-5980.656,-3934.785;Inherit;False;1363.14;495.5899;Comment;7;247;241;282;239;281;291;292;VerticalGradientRemap;1,1,1,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;206;-4241.976,-1730.101;Inherit;False;Property;_SmoothnessMultiplier;SmoothnessMultiplier;17;0;Create;True;0;0;False;0;1;0.58;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;21;-3252.778,565.9901;Inherit;False;Diffuse;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CommentaryNode;236;-4455.853,-4395.312;Inherit;False;4478.916;971.2129;Comment;17;221;227;232;228;233;269;234;274;273;272;249;268;275;265;223;226;283;OpacityMask;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;226;-4387.381,-4209.681;Inherit;True;Property;_DissolveTexture;DissolveTexture;29;0;Create;True;0;0;False;1;Header(Dissolve);358f2b2518e507e4da371639cb74e406;67fdbd503f56c404daa61bac3a64e99e;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
Node;AmplifyShaderEditor.PosVertexDataNode;239;-5729.212,-3704.468;Inherit;False;0;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;144;-4309.352,-1475.765;Inherit;False;21;Diffuse;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.IntNode;281;-5746.256,-3547.497;Inherit;False;Property;_HeightVertexAxis;Height Vertex Axis;32;1;[Enum];Create;True;3;X;0;Y;1;Z;2;0;False;0;1;0;0;1;INT;0
Node;AmplifyShaderEditor.LerpOp;141;-4099.382,-1487.272;Inherit;False;3;0;FLOAT3;0.05,0.05,0.05;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.Vector4Node;285;-5551.25,-4179.957;Inherit;False;Property;_HeightGradientAndDissolveRemap;HeightGradientAndDissolveRemap;37;0;Create;True;0;0;False;0;0,1,0,1;0,1,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.FunctionNode;282;-5479.251,-3691.897;Inherit;False;Switch;-1;;31;ef8df9ee20085f74db0149565f949658;5,28,0,30,0,29,0,15,0,9,1;17;4;INT;0;False;2;FLOAT;0;False;16;FLOAT2;0,0;False;20;FLOAT3;0,0,0;False;24;FLOAT4;0,0,0,0;False;21;FLOAT3;0,0,0;False;25;FLOAT4;0,0,0,0;False;3;FLOAT;0;False;17;FLOAT2;0,0;False;18;FLOAT2;0,0;False;26;FLOAT4;0,0,0,0;False;5;FLOAT;0;False;22;FLOAT3;0,0,0;False;23;FLOAT3;0,0,0;False;6;FLOAT;0;False;19;FLOAT2;0,0;False;27;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;284;-4094.732,-4031.338;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.IntNode;265;-3760.641,-4284.326;Inherit;False;Property;_DissolveChannel;DissolveChannel;35;1;[Enum];Create;True;4;R;0;G;1;B;2;A;3;0;False;0;0;1;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;223;-4347.371,-3633.311;Inherit;False;Property;_Value;Value;31;0;Create;True;0;0;False;0;1;0.351;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;283;-3844.652,-4179.677;Inherit;True;Property;_TextureSample5;Texture Sample 5;38;0;Create;True;0;0;False;0;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TFHCRemapNode;241;-5229.198,-3703.958;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;145;-3883.294,-1549.51;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;268;-3446.802,-4203.487;Inherit;False;Switch;-1;;20;ef8df9ee20085f74db0149565f949658;5,28,0,30,0,29,0,15,0,9,2;17;4;INT;0;False;2;FLOAT;0;False;16;FLOAT2;0,0;False;20;FLOAT3;0,0,0;False;24;FLOAT4;0,0,0,0;False;21;FLOAT3;0,0,0;False;25;FLOAT4;0,0,0,0;False;3;FLOAT;0;False;17;FLOAT2;0,0;False;18;FLOAT2;0,0;False;26;FLOAT4;0,0,0,0;False;5;FLOAT;0;False;22;FLOAT3;0,0,0;False;23;FLOAT3;0,0,0;False;6;FLOAT;0;False;19;FLOAT2;0,0;False;27;FLOAT4;0,0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;247;-5009.515,-3698.333;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;275;-3761.763,-3961.283;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;150;-3610.463,-1539.372;Inherit;False;Specular;-1;True;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;155;-3248.136,1794.75;Inherit;False;150;Specular;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;154;-3263.361,1713.841;Inherit;False;21;Diffuse;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;272;-3235.05,-3988.854;Inherit;True;Gradient Filler;-1;;23;c122245c5a2a9fa42a229f3b2183f655;1,15,0;3;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;0.25;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;249;-3253.08,-3749.615;Inherit;True;Gradient Filler;-1;;26;c122245c5a2a9fa42a229f3b2183f655;1,15,0;3;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;0.25;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;211;-3241.379,1863.134;Inherit;False;Property;_MaxGlossiness;MaxGlossiness;18;0;Create;True;0;0;False;0;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;212;-3014.685,1800.328;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;1,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SaturateNode;180;-2996.893,1724.125;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;273;-2880.99,-3926.775;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;156;-2724.577,1796.328;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RelayNode;274;-2684.196,-3929.102;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;269;-2817.388,-4013.978;Inherit;False;Property;_StepValue;StepValue;36;0;Create;True;0;0;False;0;0;0.201;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;198;-2528.786,2123.17;Inherit;False;Property;_AmbientLightInfluence;AmbientLight Influence;26;0;Create;True;0;0;False;0;0.2;0.257;0;0.5;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;234;-2652.504,-3817.874;Inherit;False;Property;_BorderMask;BorderMask;34;0;Create;True;0;0;False;0;0.05;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;161;-2438.174,2047.971;Inherit;False;83;BaseColor;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.ColorNode;228;-2404.137,-3718.941;Inherit;False;Property;_DissolveBorderColor;DissolveBorderColor;30;1;[HDR];Create;True;0;0;False;0;1,1,1,0;2.191544,5.340313,4.72758,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;160;-2231.005,2005.145;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;157;-2562.461,1869.334;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;167;-3159.164,-4657.544;Inherit;False;Debug;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;233;-2410.869,-3970.094;Inherit;True;MaskAndBorder;0;;29;9293e3882682a034aad4a12404095a1a;1,23,1;3;1;FLOAT;0;False;2;FLOAT;0.05;False;3;FLOAT;0.05;False;2;FLOAT;9;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;174;-1998.288,1450.9;Inherit;False;Property;_OutputSelection;Output Selection;25;1;[Enum];Create;True;4;Total;0;Diffuse;1;Specular;2;Debug;3;0;False;0;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;176;-1965.75,1549.026;Inherit;False;21;Diffuse;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TFHCCompareWithRange;294;-4769.955,-3795.288;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;1E-05;False;2;FLOAT;0.99999;False;3;FLOAT;0;False;4;FLOAT;0.5;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;158;-2072.089,1877.971;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;232;-2059.872,-3826.407;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.GetLocalVarNode;177;-1960.75,1616.026;Inherit;False;150;Specular;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.GetLocalVarNode;178;-1881.677,2068.785;Inherit;False;167;Debug;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;288;-4487.93,-3799.993;Inherit;False;RemapHeight;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;227;-1928.087,-3819.358;Inherit;False;BorderMask;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;175;-1670.96,1776.608;Inherit;False;Switch;-1;;30;ef8df9ee20085f74db0149565f949658;5,28,3,30,3,29,3,15,3,9,2;17;4;FLOAT;0;False;2;FLOAT;0;False;16;FLOAT2;0,0;False;20;FLOAT3;0,0,0;False;24;FLOAT4;0,0,0,0;False;21;FLOAT3;0,0,0;False;25;FLOAT4;0,0,0,0;False;3;FLOAT;0;False;17;FLOAT2;0,0;False;18;FLOAT2;0,0;False;26;FLOAT4;0,0,0,0;False;5;FLOAT;0;False;22;FLOAT3;0,0,0;False;23;FLOAT3;0,0,0;False;6;FLOAT;0;False;19;FLOAT2;0,0;False;27;FLOAT4;0,0,0,0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.GetLocalVarNode;229;318.4127,20.11437;Inherit;False;227;BorderMask;1;0;OBJECT;;False;1;COLOR;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;221;-1828.193,-3956.733;Inherit;False;DissolveMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;290;330.3171,138.4711;Inherit;False;288;RemapHeight;1;0;OBJECT;;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;231;335.9744,321.3692;Inherit;False;221;DissolveMask;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;22;341.0931,396.4982;Inherit;False;162;Output;1;0;OBJECT;;False;1;FLOAT4;0
Node;AmplifyShaderEditor.OneMinusNode;291;-5052.707,-3548.986;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;238;355.1996,474.116;Inherit;False;167;Debug;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.FractNode;287;-4906.321,-3395.336;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;35;-2389.385,-1993.187;Inherit;False;Property;_FresnelInfo;FresnelInfo;20;0;Create;True;0;0;False;0;0,0,0;0,1.04,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ToggleSwitchNode;289;522.9862,90.12178;Inherit;False;Property;_CheckRemapHeight;Check RemapHeight;33;0;Create;True;0;0;False;0;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;42;-1528.809,-1900.249;Inherit;False;Property;_FresnelShadowing;FresnelShadowing;22;0;Create;True;0;0;False;0;0;0.955;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;38;-1394.545,-1683.339;Inherit;False;Property;_FresnelStep;FresnelStep;21;0;Create;True;0;0;False;0;0;0.375;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.WorldPosInputsNode;193;-4648.221,-2416.938;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ToggleSwitchNode;203;-5390.867,765.2813;Inherit;False;Property;_InvertGradient;Invert Gradient;27;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ToggleSwitchNode;292;-4730.93,-3507.455;Inherit;False;Property;_InvertHeightMap;InvertHeightMap;38;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;282;4;281;0
WireConnection;282;2;239;1
WireConnection;282;3;239;2
WireConnection;282;5;239;3
WireConnection;284;2;226;0
WireConnection;208;0;140;0
WireConnection;208;1;207;0
WireConnection;208;2;163;0
WireConnection;283;0;226;0
WireConnection;283;1;284;0
WireConnection;241;0;282;0
WireConnection;241;1;285;1
WireConnection;241;2;285;2
WireConnection;145;0;208;0
WireConnection;145;1;141;0
WireConnection;268;4;265;0
WireConnection;268;2;283;1
WireConnection;268;3;283;2
WireConnection;268;5;283;3
WireConnection;268;6;283;4
WireConnection;247;0;241;0
WireConnection;275;0;223;0
WireConnection;275;3;285;3
WireConnection;275;4;285;4
...
ASEEND*/
//CHKSM=55D5F580829EDB6E7FEFBE34FF7C0BDF4BEF7D53