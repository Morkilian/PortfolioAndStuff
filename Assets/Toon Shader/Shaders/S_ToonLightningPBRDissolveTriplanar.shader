...
Shader "TFE/Toon/Lightning PBR Dissolve Triplanar"
{
	Properties
	{
		...
		_DissolveTilingRemapValue("DissolveTilingRemapValue", Vector) = (1,1,0,1)
		_TriplanarDissolvelGradientBorder("TriplanarDissolvelGradientBorder", Float) = 0
		_TriplanarVerticalGradientMinMaxOffset("TriplanarVerticalGradientMinMaxOffset", Vector) = (0,1,0,0)
	...
	SubShader
	{
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float temp_output_7_0_g20 = (( (float)temp_output_4_0_g20 == 0.0 ) ? triplanar237.x :  triplanar237.y );
			float temp_output_12_0_g20 = (( (float)temp_output_4_0_g20 == 2.0 ) ? triplanar237.z :  temp_output_7_0_g20 );
			float temp_output_3_0_g23 = (( (float)temp_output_4_0_g20 == 3.0 ) ? triplanar237.w :  temp_output_12_0_g20 );
			...
			float temp_output_3_0_g26 = saturate( (0.0 + (( ase_vertex3Pos.y + _TriplanarVerticalGradientMinMaxOffset.z ) - _TriplanarVerticalGradientMinMaxOffset.x) * (1.0 - 0.0) / (_TriplanarVerticalGradientMinMaxOffset.y - _TriplanarVerticalGradientMinMaxOffset.x)) );
			float temp_output_4_0_g26 = temp_output_257_0;
			...
			float Debug167 = frac( ase_vertex3Pos.y );
			...
			float4 temp_output_7_0_g30 = (( temp_output_4_0_g30 == 0.0 ) ? ( ( ( saturate( Diffuse21 ) + clampResult212 ) * float4( ( ase_lightColor.rgb * ase_lightAtten ) , 0.0 ) ) + temp_output_160_0 ) :  Diffuse21 );
			float4 temp_output_12_0_g30 = (( temp_output_4_0_g30 == 2.0 ) ? Specular150 :  temp_output_7_0_g30 );
			float4 Output162 = (( temp_output_4_0_g30 == 3.0 ) ? temp_cast_7 :  temp_output_12_0_g30 );
			c.rgb = Output162.xyz;
			c.a = 1;
...
/*ASEBEGIN
Version=17402
296;73;827;595;-202.9292;-140.8764;1;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;14;-6280.826,-1044.389;Inherit;True;Property;_NormalTex;NormalTex;13;1;[Normal];Create;True;0;0;False;0;ea423bfa3028414449f0585c59cb25c5;02b3a375f0af6144aa48be89e4980601;True;bump;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;215;-5372.189,-1424.13;Inherit;True;Property;_MetalMap;MetalMap;27;0;Create;True;0;0;False;0;None;209b9f5e35c243c4bbd7666ab799b120;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.CommentaryNode;236;-4455.853,-4395.312;Inherit;False;4478.916;971.2129;Comment;24;279;221;227;232;228;233;269;234;274;273;272;249;257;268;275;265;237;256;276;263;223;278;226;262;OpacityMask;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.Vector3Node;258;-5208.983,-3876.569;Inherit;False;Property;_TriplanarVerticalGradientMinMaxOffset;TriplanarVerticalGradientMinMaxOffset;34;0;Create;True;0;0;False;0;0,1,0;0,1.6,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector4Node;262;-4369.417,-4270.82;Inherit;False;Property;_DissolveTilingRemapValue;DissolveTilingRemapValue;32;0;Create;True;0;0;False;0;1,1,0,1;0.25,0.25,0,1;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;278;-4426.892,-3749.664;Inherit;False;Global;BossDissolve;BossDissolve;37;0;Create;True;0;0;False;0;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;223;-4409.735,-3825.595;Inherit;False;Property;_Value;Value;30;0;Create;True;0;0;False;0;1;0.351;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;226;-4381.811,-4073.213;Inherit;True;Property;_DissolveTexture;DissolveTexture;28;0;Create;True;0;0;False;1;Header(Dissolve);358f2b2518e507e4da371639cb74e406;67fdbd503f56c404daa61bac3a64e99e;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.ToggleSwitchNode;276;-4140.224,-3855.665;Inherit;False;Property;_GlobalValue;GlobalValue;37;0;Create;True;0;0;False;0;0;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.IntNode;265;-3757.44,-4332.333;Inherit;False;Property;_DissolveChannel;DissolveChannel;35;1;[Enum];Create;True;4;R;0;G;1;B;2;A;3;0;False;0;0;1;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;256;-4323.27,-3546.36;Inherit;False;Property;_TriplanarDissolvelGradientBorder;TriplanarDissolvelGradientBorder;33;0;Create;True;0;0;False;0;0;0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;247;-4660.348,-3702.697;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;275;-3853.671,-3872.161;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FractNode;280;-5094.455,-3397.501;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;269;-2842.897,-4279.483;Inherit;False;Property;_StepValue;StepValue;36;0;Create;True;0;0;False;0;0;0.201;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RelayNode;274;-2684.196,-3929.102;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;234;-2602.969,-3823.377;Inherit;False;Property;_BorderMask;BorderMask;31;0;Create;True;0;0;False;0;0.05;0.05;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;167;-4940.354,-3401.067;Inherit;False;Debug;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;228;-2239.476,-3743.417;Inherit;False;Property;_DissolveBorderColor;DissolveBorderColor;29;1;[HDR];Create;True;0;0;False;0;1,1,1,0;2.191544,5.340313,4.72758,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;232;-1839.582,-3850.883;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;227;-1647.718,-3839.384;Inherit;False;BorderMask;-1;True;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TFHCCompareEqual;279;-4211.076,-3696.913;Inherit;False;4;0;FLOAT;0;False;1;FLOAT;1;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=8395B6DAB4A8DD970E5483A1EFF04638FF2247C1